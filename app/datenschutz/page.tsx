    ...
    <main className="px-4 max-w-screen-xl mx-auto py-8 prose prose-slate">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <h3 className="text-xl font-medium mb-3">Strato</h3>
          <p className="mb-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-medium mb-3">
            Widerspruch gegen die Datenerhebung in besonderen F&auml;llen sowie
        ...
        <section>
          ...
          <h3 className="text-xl font-medium mb-3">Facebook</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-medium mb-3">Instagram</h3>
          <p className="mb-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-medium mb-3">Newsletter&shy;daten</h3>
          <p className="mb-4">
